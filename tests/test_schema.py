...
baseline_meta = schema.get_schema('/workspace/git/EticaAI/HXL-Data-Science-file-formats/hxlm/data/baseline/hmeta.yml')
...
print(schema.export_schema_yaml(baseline_meta))
...
print(schema.export_schema_json(baseline_meta))
