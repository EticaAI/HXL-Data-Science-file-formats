= `+HXLTM+` Terminologius Multilinguam: archīvum fōrmātum normam
:toc: preamble
:toclevels: 3
:icons: font
...
[#HXLTM]
=== `+HXLTM+`
==== Terminologius Multilinguam (priore HXL Trānslātiōnem Memoriam), Datum ideam

////
Naming the HXL TM

Terminologius Multilinguam
...
[#HXLTM-TMETA]
=== `+HXLTM-TMETA+`:
==== HXLTM Terminologius Multilinguam Meta
